...
class Arsene_Widget_Editor_Picks extends WP_Widget {

	function __construct() {
		$widget_ops = array( 'description' => __( "Displays Editor Picks posts.","arsene") );
		parent::__construct('editor_picks', __('Arsene Editor Picks',"arsene"), $widget_ops);
	}
